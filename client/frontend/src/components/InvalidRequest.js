...
const InvalidRequest = () => {
    return (<div className="invalid-request">
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", height: "100%", alignItems: "center" }}>
            ...
            <div style={{ fontSize: "3vh", alignSelf: "center", textAlign: "center", color: "#063773" }}>unfortunately this site does not exist</div>
            <img src="https://dejpknyizje2n.cloudfront.net/svgcustom/clipart/preview/penguin-7837-16545-550x550.png" style={{ height: "20vh", marginTop: "20px" }}></img>
